...
feature "Leagues" do
  ...
  let!(:game1) { create(:game, game_type: fifa, player_id: players[0].id, opponent_id: players[2].id, player_score: 3, opponent_score: 1) }
  ...
  let!(:game4) { create(:game, game_type: fifa, player_id: players[2].id, opponent_id: players[3].id, player_score: 4, opponent_score: 2) }
  ...
  scenario "view league" do
    ...
    expect(page).to_not have_content players[1].full_name
  end
